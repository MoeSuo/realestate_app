...
import LayoutLeftImage from "../../pages/components/layoutLeftImage";
...
export default function Login({ onLogIn }) {
  ...
  return (
    <LayoutLeftImage>
      ...
      <div className="card relative px-10 py-16  min-w-[70%]">
        <Image
          src={logo}
          alt="logo image"
          priority
        ...
        <div className="form ">
          ...
          <button
            ...
            type="submit"
            className="w-full 
            text-white  bg-[#414f6f] hover:bg-[#7484a8] focus:ring-4 focus:ring-stone-200 font-medium rounded text-sm px-4 py-3 mr-2 mb-2"
          >
